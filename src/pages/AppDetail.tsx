...
import { Download, Shield, Lock, Info, ChevronRight, Check, ArrowLeft } from "lucide-react";
...
export function AppDetail() {
  ...
  useEffect(() => {
    if (app) {
      document.title = `${app.name} | Limanex Studio`;
      const metaDesc = document.querySelector('meta[name="description"]');
      if (metaDesc) {
        metaDesc.setAttribute("content", app.short_description);
      }
    }
  }, [app]);
  ...
  if (!app) {
    return (
      <div className="min-h-screen bg-[#0F172A] text-white flex flex-col items-center justify-center p-6 text-center">
        ...
        <Link to="/" className="text-[#4F7CFF] hover:underline flex items-center gap-2">
  ...
  return (
    <div className="bg-[#0F172A] min-h-screen text-white font-sans selection:bg-[#4F7CFF] selection:text-white">
      ...
      <main className="relative z-10 pt-32 pb-40 flex flex-col items-center">
        {/* HERO SECTION */}
        <section className="w-full max-w-7xl mx-auto px-6 lg:px-8 py-20 md:py-32 flex flex-col lg:flex-row items-center gap-16 relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[radial-gradient(ellipse_at_center,_rgba(79,124,255,0.08),_transparent_70%)] pointer-events-none -m-10"></div>
          <motion.div 
          ...
          >
            ...
            <div className="flex flex-col items-start gap-4">
              <a href={app.playstore_link} target="_blank" rel="noopener noreferrer" className="group relative px-10 py-5 rounded-2xl text-[16px] font-bold uppercase tracking-[0.1em] transition-all duration-300 w-full sm:w-auto hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(79,124,255,0.6)] active:scale-95">
                <div className="absolute inset-0 bg-gradient-to-r from-[#4F7CFF] via-[#22D3EE] to-[#8B5CF6] rounded-2xl opacity-100 group-hover:opacity-100 transition-all blur-[8px] group-hover:blur-[16px]"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-[#4F7CFF] via-[#22D3EE] to-[#8B5CF6] rounded-2xl border border-white/30 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]"></div>
              ...
              <p className="mt-2 text-[13px] text-[#A1A1A6] font-medium flex items-center gap-2">
                <Check className="w-4 h-4 text-[#22D3EE]" /> Free to use • No sign-up required
              </p>
            </div>
          </motion.div>
          ...
          >
             {/* Mockup remains the same for aesthetic consistency, could be dynamic in future */}
        ...
        {/* TRUST SECTION */}
        <section className="w-full max-w-5xl mx-auto px-6 py-20 md:py-28 relative">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#4F7CFF]/5 to-transparent pointer-events-none -z-10"></div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col justify-center items-center gap-5 bg-[#111827]/40 backdrop-blur-md p-8 rounded-[32px] border border-[#1E293B]/50 text-center hover:bg-[#111827]/80 hover:border-[#4F7CFF]/30 transition-all duration-500 shadow-xl relative group">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#4F7CFF]/20 to-[#4F7CFF]/5 flex items-center justify-center shrink-0 border border-[#4F7CFF]/20 shadow-[0_0_20px_rgba(79,124,255,0.2)]">
            ...
            <div className="flex flex-col justify-center items-center gap-5 bg-[#111827]/40 backdrop-blur-md p-8 rounded-[32px] border border-[#1E293B]/50 text-center hover:bg-[#111827]/80 hover:border-[#22D3EE]/30 transition-all duration-500 shadow-xl relative group">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#22D3EE]/20 to-[#22D3EE]/5 flex items-center justify-center shrink-0 border border-[#22D3EE]/20 shadow-[0_0_20px_rgba(34,211,238,0.2)]">
            ...
            <div className="flex flex-col justify-center items-center gap-5 bg-[#111827]/40 backdrop-blur-md p-8 rounded-[32px] border border-[#1E293B]/50 text-center hover:bg-[#111827]/80 hover:border-[#8B5CF6]/30 transition-all duration-500 shadow-xl relative group">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#8B5CF6]/20 to-[#8B5CF6]/5 flex items-center justify-center shrink-0 border border-[#8B5CF6]/20 shadow-[0_0_20px_rgba(139,92,246,0.2)]">
        ...
        {/* FEATURES SECTION */}
        <section className="w-full py-32 relative bg-gradient-to-b from-[#0F172A] via-[#111827] to-[#0F172A]">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[1px] bg-gradient-to-r from-transparent via-white/5 to-transparent"></div>
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {app.features.map((feature, i) => (
                <div key={i} className="bg-[#111827]/60 backdrop-blur-lg p-10 rounded-[32px] border border-white/5 hover:border-white/10 transition-colors shadow-2xl relative group overflow-hidden">
                  ...
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#4F7CFF] to-[#0F172A] flex items-center justify-center mb-8 shadow-[0_0_30px_rgba(79,124,255,0.3)]">
                    <DynamicIcon name={feature.iconName} className="w-7 h-7 text-white" />
                  </div>
        ...
        <section className="w-full py-32 overflow-hidden bg-gradient-to-b from-[#0F172A] via-[#111827]/80 to-[#0F172A]">
          <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
             <h2 className="text-[40px] md:text-[56px] font-semibold tracking-[-0.03em] text-white">Designed for clarity</h2>
          </div>
          <div className="flex gap-12 px-6 md:px-12 overflow-x-auto pb-24 pt-16 snap-x hide-scrollbar justify-start md:justify-center">
        ...
        {/* DOWNLOAD SECTION */}
        <section className="w-full max-w-4xl mx-auto px-6 py-32 text-center relative">
          <h2 className="text-[48px] md:text-[72px] font-semibold tracking-[-0.03em] text-white mb-10 leading-[1.05]">
            Take control of your health
          </h2>
          <a href={app.playstore_link} target="_blank" rel="noopener noreferrer" className="group relative px-12 py-6 rounded-[2rem] text-[18px] md:text-[20px] font-bold uppercase tracking-[0.1em] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(34,211,238,0.6)] active:scale-95 mx-auto flex items-center justify-center gap-4 w-full sm:w-auto">
            <div className="absolute inset-0 bg-gradient-to-r from-[#4F7CFF] via-[#22D3EE] to-[#8B5CF6] rounded-[2rem] opacity-100 transition-all duration-500 blur-[12px] group-hover:blur-[24px]"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-[#4F7CFF] via-[#22D3EE] to-[#8B5CF6] rounded-[2rem] border border-white/40 shadow-[inset_0_1px_1px_rgba(255,255,255,0.6)]"></div>
