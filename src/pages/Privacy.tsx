      ...
      <main className="flex-grow pt-32 pb-32 px-6 max-w-7xl mx-auto w-full relative">
        ...
        >
          <header className="mb-16 text-center border-b border-white/10 pb-12">
            <div className="inline-flex items-center justify-center p-4 rounded-2xl bg-[#4F7CFF]/10 border border-[#4F7CFF]/20 mb-6">
          ...
          <div className="space-y-12 text-[17px] leading-[1.8] text-[#CBD5F5]">
            <section className="space-y-5">
              <h2 className="text-[28px] font-semibold text-white tracking-tight">Application Policies</h2>
              ...
              <div className="grid grid-cols-1 gap-4 mt-8">
                <Link 
                  to="/privacy/vitacase" 
                  className="group flex items-center justify-between p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-[#4F7CFF]/10 hover:border-[#4F7CFF]/30 transition-all duration-300"
                >
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#4F7CFF] to-[#8B5CF6] flex items-center justify-center shadow-lg">
                  ...
                  <ChevronRight className="w-6 h-6 text-[#CBD5F5] group-hover:text-white group-hover:translate-x-1 transition-all" />
                </Link>
              </div>
            </section>

            <section className="space-y-5">
              <h2 className="text-[28px] font-semibold text-white tracking-tight">Our Philosophy</h2>
